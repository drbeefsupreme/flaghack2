...
pub const FLAGIC_MAX: u8 = 100;
pub const FLAGIC_GAIN_RATE: f32 = 5.0;
...
pub const HIPPIE_START_ONE_FLAG_CHANCE: f32 = 0.33;
pub const HIPPIE_START_TWO_FLAG_CHANCE: f32 = 0.10;
